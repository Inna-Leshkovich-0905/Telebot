...
cursor.execute('''SELECT*FROM tab_1''') # * означает, что из таблицы достается всё из таблицы 2
...
# conn.commit()
# cursor.execute('''DELETE FROM tab_1 WHERE col_1 ='7' ''')
# conn.commit()
# cursor.execute('''DELETE FROM tab_1 WHERE col_1 ='15' ''')
# conn.commit()
