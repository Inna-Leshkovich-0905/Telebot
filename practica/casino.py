...
i = 0
while (i<5):
    i = i + 1  # i += 1 - синтаксис также добавляет к i единицу
    c = int(input('Введите число от 1 от 10: ' ))
    d = int(input('Введите число от 1 до 2 (1 - красный, 2 - чёрный): '))
    if a ==c and b ==d:
        print(f'Вы угадали цвет и число: {c} {d}.') # f - это форматированный вывод строки, {c}{d} - переменные, которые внедрены в текст
        break
    elif a !=c and b == d:
