...
# добавила я:
        self.div_c = QPushButton('//', self)
        self.div_c.resize(50, 50)
        self.div_c.move(5, 320)

        self.div_o = QPushButton('%', self)
        self.div_o.resize(50, 50)
        self.div_o.move(60, 320)

        self.kvadrat = QPushButton('x²', self)
        self.kvadrat.resize(50, 50)
        self.kvadrat.move(115, 320)
...
# добавила я:
        self.div_c.clicked.connect(self.div_c_1)
        self.div_o.clicked.connect(self.div_o_1)
